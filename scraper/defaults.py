...
content = [
    ...
    Part('WYZNANIE WIARY', [
        ...
        Part('WYZNANIE WIARY CHRZEŚCIJAŃSKIEJ', [
    ...
    Part('CELEBRACJA MISTERIUM CHRZEŚCIJAŃSKIEGO', [
        ...
        Part('SIEDEM SAKRAMENTÓW KOŚCIOŁA', [
    ...
    Part('ŻYCIE W CHRYSTUSIE', [
        ...
        Part('POWOŁANIE CZŁOWIEKA: ŻYCIE W DUCHU ŚWIĘTYM', [
    ...
    Part('MODLITWA CHRZEŚCIJAŃSKA', [
        Part('MODLITWA W ŻYCIU CHRZEŚCIJAŃSKIM', [
        ...
        Part('MODLITWA PAŃSKA "OJCZE NASZ"', [
